...
uint32_t Jet::algoFlavCode(const reco::FlavAlgo& algo) const { return jetFlavourInfo_.getAlgoFlavCode(algo); }

uint32_t Jet::algoFlavCode(const uint8_t& algoNum) const {
