...
CaloGeometryHelper::CaloGeometryHelper(const CaloGeometry& pG, const CaloTopology& theTopology, double bField) {
  setupGeomTopo(pG, theTopology);
  setupHelper(bField);
}

void CaloGeometryHelper::setupHelper(double bField) {
  psLayer1Z_ = 303;
  psLayer2Z_ = 307;
