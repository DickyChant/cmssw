...
for f in flashjet_gpu.sub flashjet_sonic.sub flashjet_real.sub flashjet_sonic_real.sub tasks_gpu.txt tasks_sonic.txt tasks_real.txt tasks_sonic_real.txt flashjet_sonic_multi.sub tasks_sonic_multi.txt; do
